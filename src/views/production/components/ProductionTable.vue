<template>
  <div class="ProductionTable">
    ...
    >
      <el-table-column prop="taskId" label="序号" />
      <el-table-column prop="projectName" label="项目名称" />
      <el-table-column prop="taskProductionType" label="生产类型" />
      <el-table-column prop="psAsphaltGrade" label="生产类型" />
      <el-table-column prop="psHotMaterialData" label="添加剂" />
      <el-table-column prop="taskSupplyTime" label="供货时间" />
      <el-table-column prop="taskPlannedQuantity" label="供货数量" />
      <el-table-column prop="psFactoryTemperature" label="出厂料温" />
      <el-table-column prop="useTotal" label="以供数量" />
...
export default {
  ...
  watch: {
    arr() {
      this.tableData = this.arr.productionTaskVOList
    }
  },
  methods: {
    getRowClass() {
